        ...
        const unsubscribe = onValue(ridesRef, (snapshot) => {
            if (snapshot.exists()) {
                ...
                snapshot.forEach((child) => {
                    const r = { id: child.key, ...child.val() } as Ride;
                    if (r.driverId === user.uid && ['ACCEPTED', 'ARRIVING', 'STARTED'].includes(r.status)) {
                        activeRide = r;
                    }
                });
                setRide(activeRide);
    ...
    const updateRideStatus = async (status: string) => {
        ...
        try {
            ...
            if (status === 'ARRIVING') {
                ...
                const earnings = (ride.fare || 0) * 0.8; // 80% to driver
    ...
    if (!ride) {
        return (
            <div className="text-center py-12">
                ...
                <p className="text-gray-400 mb-6">You don't have any active trips right now</p>
                    ...
                    <Card>
                        ...
                        <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-800">
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-lg font-bold text-emerald-400">${((ride.fare || 0) * 0.8).toFixed(2)}</p>
